...
PROJECT_NAME ?= provider-restapi
PROJECT_REPO ?= github.com/nkvoll/$(PROJECT_NAME)

export TERRAFORM_VERSION ?= 1.5.7

export TERRAFORM_PROVIDER_SOURCE ?= nkvoll/restapi
...
xpkg.build.provider-restapi: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/restapis/01-delete.yaml.tmpl.
