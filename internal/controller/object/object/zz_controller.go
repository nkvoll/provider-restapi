...
import (
	...
	v1alpha1 "github.com/nkvoll/provider-restapi/apis/object/v1alpha1"
	features "github.com/nkvoll/provider-restapi/internal/features"
)
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["restapi_object"], tjcontroller.WithLogger(o.Logger), tjcontroller.WithConnectorEventHandler(eventHandler),
